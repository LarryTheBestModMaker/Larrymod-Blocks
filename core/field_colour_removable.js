...
goog.provide('Blockly.FieldColourInputRemovable');
 ...
 *     in the text field.
 * @extends {Blockly.FieldColourSlider}
 * @constructor
 */
Blockly.FieldColourInputRemovable = function(text, opt_validator, opt_restrictor) {
  Blockly.FieldColourInputRemovable.superClass_.constructor.call(this, text,
      opt_validator, opt_restrictor);
};
goog.inherits(Blockly.FieldColourInputRemovable, Blockly.FieldColourSlider);

/**
 * Show the inline free-text editor on top of the text with the remove button.
 * @private
 */
Blockly.FieldColourInputRemovable.prototype.showEditor_ = function() {
  Blockly.FieldColourInputRemovable.superClass_.showEditor_.call(this);
 ...
 * @private
 */
Blockly.FieldColourInputRemovable.prototype.removeCallback_ = function() {
 ...
 *                          spellcheck).
 * @returns {!Blockly.FieldColourInputRemovable} The new text input.
 * @public
 */
Blockly.FieldColourInputRemovable.fromJson = function(options) {
  var text = Blockly.utils.replaceMessageReferences(options['text']);
  var field = new Blockly.FieldColourInputRemovable(text, options['class']);
...
Blockly.Field.register(
    'field_colour_removable', Blockly.FieldColourInputRemovable);
